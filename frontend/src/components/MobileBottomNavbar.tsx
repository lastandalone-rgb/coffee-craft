...
export const MobileBottomNavbar: React.FC<MobileBottomNavbarProps> = ({
  ...
  return (
    <nav id="mobile-bottom-nav" className="lg:hidden fixed bottom-6 left-4 right-4 max-w-md mx-auto bg-[#140e0b]/90 backdrop-blur-xl border border-[#c68642]/25 rounded-full z-40 flex items-center justify-between px-2 shadow-[0_10px_30px_rgba(0,0,0,0.8),_0_0_15px_rgba(198,134,66,0.15)] overflow-hidden">
      <div className="relative flex w-full items-center justify-between py-2">
        {/* Sliding Active Pill Background Indicator */}
        <div 
          id="mobile-bottom-nav-indicator"

...
export const BrewChart: React.FC<BrewChartProps> = ({ stats, activeTab, setActiveTab }) => {
  ...
  return (
    <div className="w-full">
      <div className="flex gap-2 mb-4 bg-[#140e0b]/60 p-1 rounded-xl border border-zinc-800 self-start w-fit">
        ...
        <svg viewBox={`0 0 ${width} ${height}`} className="w-full min-w-[500px] overflow-visible">
          <defs>
            ...
            <linearGradient id="goldGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#e0b034" stopOpacity="0.3" />
